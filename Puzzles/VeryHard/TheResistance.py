...
# Even if calculating an exact value for P if difficult, this value will always be a subset of D, and is evaluated to 25 for the last test case of codigame.
